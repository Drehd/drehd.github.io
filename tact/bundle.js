// bundle.js - Combined exploit scripts
...
function stage2_ () {
	...
	if (isDoExploit) {
		window.log("Kernel exploit complete! Testkit activation successful.", "green");
	}
		...
		if (bin_loader) {
			...
			if (mapped_address == '926100000') {
				try {
					...
					window.log("Awaiting payload...", "green");
				} catch (e) {
					alert(e);
				}
			}
			...
			runPayload("ps4-testkit-activator-5.05.bin");
			window.log("You're all set! Activation complete.", "green");
		}
	}
}
